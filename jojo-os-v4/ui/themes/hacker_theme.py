...
class HackerTheme:
    # Adicione estas 4 cores aqui em cima
    BLACK = "#0a0a0a"
    GOLD = "#00ff00"  # No hacker, o "Gold" é verde
    PURPLE = "#003b00" # Verde escuro para números
    PINK = "#008f11"   # Verde matrix para operadores
    WHITE = "#ffffff" # Branco para texto invertido
